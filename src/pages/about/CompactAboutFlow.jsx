...
function CompactPinnedCard() {
  return <div className="abt-compact-pinned-card abt-compact-pinned-card--target" aria-hidden="true">
    <span className="abt-compact-pinned-card-back" />
    <figure className="abt-compact-pinned-card-photo">
      <img src="/overview/felmex-container-lift.png" alt="" />
    </figure>
    ...
    media.add('(max-width: 1024px) and (prefers-reduced-motion: no-preference)', (context) => {
      ...
      const build = () => {
        ...
        const travel = Math.max(
          0,
          finalChapter.offsetTop + contentTop - (height - finalChapter.offsetHeight - finalBottomInset)
        );
